INSERT INTO TABLE volumes(id, title, section) VALUES 
...
-- Abteilung I: Werke
INSERT INTO TABLE works(title, abbreviation, volume_id, ordinal, year) VALUES 
...
('Gedanken von der wahren Schätzung der lebendigen Kräfte und Beurtheilung der Beweise, deren sich Herr von Leibniz und andere Mechaniker in dieser Streitsache bedient haben, nebst einigen vorhergehenden Betrachtungen, welche die Kraft der Körper überhaupt betreffen, 1746/49', 'UFE', 1, 1, '1754'),
...
INSERT INTO TABLE works(title, abbreviation, volume_id, ordinal, year) VALUES 
('Kritik der reinen Vernunft B', 'B', 3, 0, '1787');
...
('Anhang', 'HN', 20, 9, NULL);
('Einleitung', 'HN', 20, 10, NULL);
('Erläuterungen', 'HN', 20, 11, NULL);
...
('Anhang', 'OP', 23, 23, NULL),
('Einleitung', 'OP', 23, 24, NULL),
('Erläuterungen', 'OP', 23, 25, NULL),
